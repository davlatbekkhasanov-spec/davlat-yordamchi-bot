...
HUB_SEED_ROWS: tuple[tuple[str, int, str, str], ...] = (
    ...
    # 2026-06-04 — forward (04.06.2026 log)
    ("2026-06-04", 8440127425, "ombor", "Ombor (forward jami): 5 ta, ish vaqti 7245 soniya"),
    ...
    ("2026-06-04", 6001619806, "ombor", "Ombor (forward jami): 1 ta, ish vaqti 1255 soniya"),
    ("2026-06-04", 6001619806, "omborga", "Reys 1, ish 16:34, dam 0:00"),
)
